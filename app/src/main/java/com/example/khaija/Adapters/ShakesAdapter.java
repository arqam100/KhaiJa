...
public class ShakesAdapter extends RecyclerView.Adapter<ShakesAdapter.viewHolder> {

    ArrayList<ShakesRecipie> list;
    Context context;
    Intent intent;

    public ShakesAdapter(ArrayList<ShakesRecipie> list,Context context) {
        this.list = list;
    ...
    public viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shakes_recyclerview,parent,false);
